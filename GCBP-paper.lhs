...
should be the identity ``up to any |m| effects''.
  ...
  function |dom|, which intuitively extracts just the ``effects'' of a
  morphism |f|: for each |a|, the effects generated by running |f a|
  are retained, but the output of type |b| is discarded and replaced
  by |a| itself.
\begin{spec}
